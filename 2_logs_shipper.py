...
now = datetime.now()
service_url = 'pulsar+ssl://pulsar-gcp-uscentral1.streaming.datastax.com:6651'   #REPLACE BY YOUR SERVICE URL
...
topic = 'persistent://datastax-atp/events-namespace/events-topic' #REPLACE BY YOUR TOPIC
